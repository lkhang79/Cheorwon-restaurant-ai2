...
# ============================================================================
def main():
 # [수정됨] 모바일 충돌 방지: PC에서만 너비 고정, 모바일은 순정 상태 유지
    st.markdown("""
        <style>
        /* 1. PC 화면 (너비 992px 이상)에서만 사이드바 너비 고정 (385px) */
        ...
        /* 2. 모바일 화면: 강제 설정 제거 (Streamlit 기본 반응형 동작 사용) */
        /* 이전에 있던 .block-container 패딩 설정 등을 삭제하여 충돌을 방지합니다. */
